...
import { parse, ReturnValue } from '../src/parser';
...
describe('On Statement', function () 
{
    ...
    {    
        [
            ...
            { statement: 'on 1 from users set name="some one" where begins_with(name, "some") with version check', 
              expected: {type: 'on', id: 1, from: 'users', 
                        ...
                        versionCheck: true,
                        returnValue: undefined}},
            { statement: 'on "1" from users set name = "some one" set age = 25 set enabled = true returning none', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: {setExpressions: ["#name___1 = :name___1", "#age___2 = :age___2", "#enabled___3 = :enabled___3"], expressionAttributeNames: {'#name___1': 'name', '#age___2': 'age', '#enabled___3': 'enabled'}, expressionAttributeValues: {':name___1': 'some one', ':age___2': 25, ':enabled___3': true}},
                        add: undefined,
                        remove: undefined,
            ...
            { statement: 'on "1" from users set name = "some one" set age = 25 set enabled = true returning allnew with version check', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: {setExpressions: ["#name___1 = :name___1", "#age___2 = :age___2", "#enabled___3 = :enabled___3"], expressionAttributeNames: {'#name___1': 'name', '#age___2': 'age', '#enabled___3': 'enabled'}, expressionAttributeValues: {':name___1': 'some one', ':age___2': 25, ':enabled___3': true}},
                        add: undefined,
                        remove: undefined,
        ...
        [
            ...
            { statement: 'on 1 from table set a = 1, a = returning', expected: {error: "NoViableAltException", message: ErrorMessage.UNRECOGNIZED_COMMAND.replace('?', 'returning')}},
            { statement: 'on 1 from table set a = 1, a = returning invalid', expected: {error: "NoViableAltException", message: ErrorMessage.UNRECOGNIZED_COMMAND.replace('?', 'returning')}},
            { statement: 'on 1 from table set a = 1, a = with version check returning none', expected: {error: "NoViableAltException", message: ErrorMessage.UNRECOGNIZED_COMMAND.replace('?', 'with version check')}}
        ]
        .forEach(test => 
        {
    ...
    {    
        [
            ...
            { statement: 'on 1 from users add count 100, age 25 add viewed 1 where begins_with(name, "some") with version check', 
              expected: {type: 'on', id: 1, from: 'users', 
                        ...
                        versionCheck: true,
                        returnValue: undefined}},
            { statement: 'on "1" from users add count 100 add age 25, viewed 1 returning allold', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: {addExpressions: ["#count___1 :count___1", "#age___2 :age___2", "#viewed___3 :viewed___3"], expressionAttributeNames: {'#count___1': 'count', '#age___2': 'age', '#viewed___3': 'viewed'}, expressionAttributeValues: {':count___1': 100, ':age___2': 25, ':viewed___3': 1}},
                        remove: undefined,
            ...
            { statement: 'on "1" from users add count 100 add age 25, viewed 1 returning allnew with version check', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: {addExpressions: ["#count___1 :count___1", "#age___2 :age___2", "#viewed___3 :viewed___3"], expressionAttributeNames: {'#count___1': 'count', '#age___2': 'age', '#viewed___3': 'viewed'}, expressionAttributeValues: {':count___1': 100, ':age___2': 25, ':viewed___3': 1}},
                        remove: undefined,
        ...
        [
            ...
            { statement: 'on 1 from table add a 1, b =', expected: {error: "MismatchedTokenException", message: ErrorMessage.ON_ADD_MISSING_NUMBER}},
            { statement: 'on 1 from table add a 1, b 2 returning', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table add a 1, b 2 returning invalid', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table add a 1, b 2 with version check returning none', expected: {error: "NotAllInputParsedException", message: ErrorMessage.UNEXPECTED_TOKEN.replace('?', 'returning')}},
        ]
        .forEach(test => 
        {
            it(`'${test.statement}' is invalid because '${test.expected.message}'`, async () =>
    ...
    {    
        [
            ...
            { statement: 'on 1 from users remove count, age remove viewed where begins_with(name, "some") with version check', 
              expected: {type: 'on', id: 1, from: 'users', 
                        ...
                        versionCheck: true,
                        returnValue: undefined}},
            { statement: 'on "1" from users remove count remove age, viewed returning none', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: undefined,
                        remove: {removeExpressions: ["#count___1", "#age___2", "#viewed___3"], expressionAttributeNames: {'#count___1': 'count', '#age___2': 'age', '#viewed___3': 'viewed'}, expressionAttributeValues: {}},
                        ...
                        versionCheck: undefined,
                        returnValue: ReturnValue.None}},
            { statement: 'on "1" from users remove count remove age, viewed returning allOld with version check', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: undefined,
                        remove: {removeExpressions: ["#count___1", "#age___2", "#viewed___3"], expressionAttributeNames: {'#count___1': 'count', '#age___2': 'age', '#viewed___3': 'viewed'}, expressionAttributeValues: {}},
        ...
        [
            ...
            { statement: 'on 1 from table remove a returning', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table remove a returning invalid', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table remove a with version check returning none', expected: {error: "NotAllInputParsedException", message: ErrorMessage.UNEXPECTED_TOKEN.replace('?', 'returning')}},
        ]
        .forEach(test => 
        {
            it(`'${test.statement}' is invalid because '${test.expected.message}'`, async () =>
    ...
    {    
        [
            ...
            { statement: 'on 1 from users delete colors "green", numbers 42 delete bools true where begins_with(name, "some") with version check', 
              expected: {type: 'on', id: 1, from: 'users', 
                        ...
                        versionCheck: true,
                        returnValue: undefined}},
            { statement: 'on "1" from users delete colors "green" delete numbers 42, bools true returning Allnew', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: undefined,
                        remove: undefined,
                        ...
                        versionCheck: undefined,
                        returnValue: ReturnValue.AllNew}},
            { statement: 'on "1" from users delete colors "green" delete numbers 42, bools true returning Allold with version check', 
              expected: {type: 'on', id: "1", from: 'users', 
                        set: undefined,
                        add: undefined,
                        remove: undefined,
        ...
        [
            ...
            { statement: 'on 1 from table delete k "v" returning', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table delete k "v" returning invalid', expected: {error: "NoViableAltException", message: ErrorMessage.RETURNING_MISSING_VALUE}},
            { statement: 'on 1 from table delete k "v" with version check returning none', expected: {error: "NotAllInputParsedException", message: ErrorMessage.UNEXPECTED_TOKEN.replace('?', 'returning')}},
        ]
        .forEach(test => 
        {
            it(`'${test.statement}' is invalid because '${test.expected.message}'`, async () =>
    ...
    [
        { statement: 'on 1 from users set name = "some one" add age 12 remove count delete colors "green" where begins_with(name, "some") returning allold with version check', 
          expected: {type: 'on', id: 1, from: 'users', 
                     set: {setExpressions: ["#name___1 = :name___1"], expressionAttributeNames: {'#name___1': 'name'}, expressionAttributeValues: {':name___1': 'some one'}},
