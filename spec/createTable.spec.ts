...
describe('Create Table Statement', function () 
{
    ...
    [
        ...
        { statement: 'CREATE TABLE for "users"', expected: {error: "MismatchedTokenException", message: ErrorMessage.CREATE_TABLE_MISSING_ENTITY_NAME}},
        { statement: 'CREATE TABLE for 12', expected: {error: "MismatchedTokenException", message: ErrorMessage.CREATE_TABLE_MISSING_ENTITY_NAME}},
